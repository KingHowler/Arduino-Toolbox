...
namespace Arduino_Toolbox
{
    public partial class SerialMonitor : Form
    {
        ...
        bool menuOpen = true;
        int n = 3;
        public SerialMonitor(int height, int width, int x, int y , System.Windows.Forms.FormWindowState state)
        {
            InitializeComponent();
            this.Height = height;
            this.Width = width;
        ...
        //  Auto Allign
        private void SerialMonitor_SizeChanged(object sender, EventArgs e)
        {
            marginLabel.Height = ((toolStrip.Size.Height - 52) / 2) - (15 * n);
            Applet.Location = new Point((this.Size.Width / 2) - (Applet.Width / 2), (this.Size.Height / 2) - (Applet.Height / 2));
        }
        ...
        {
            Monitor.Text = "Serial Data:  " + Arduino.ReadLine();
        }
